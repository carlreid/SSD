...
namespace SSD
{
    ...
    {
        public EnemyIceBoss(Vector3 position, ModelContainer model, Entity planetSphere, PlayerEntity player, Random ran, float scale = 1, float yaw = 0, float pitch = 0, float roll = 0)
