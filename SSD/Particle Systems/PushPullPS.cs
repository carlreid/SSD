...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    class PushPullParticleSystem : DefaultSprite3DBillboardParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public PushPullParticleSystem(Game cGame) : base(cGame) { }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            ...
            InitializeSpriteParticleSystem(cGraphicsDevice, cContentManager, 1000, 5000, "Textures/Star2", cSpriteBatch);
