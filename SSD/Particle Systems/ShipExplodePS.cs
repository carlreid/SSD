...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    public class ShipExplodeParticleSystem : DefaultTexturedQuadTextureCoordinatesParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public ShipExplodeParticleSystem(Game game) : base(game) { }
        ...
        {
            particle.Lifetime = RandomNumber.Between(2.5f, 4.0f);
            particle.Color = ExplosionColor;
            particle.Position = Emitter.PositionData.Position;
            particle.Velocity = DPSFHelper.RandomNormalizedVector() * RandomNumber.Next(100, 445);
            particle.Right = -particle.Velocity;
            particle.Width = ExplosionParticleSize * RandomNumber.Next(1, 4);
