...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    class ShipBombExplodeParticleSystem : DefaultTexturedQuadTextureCoordinatesParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public ShipBombExplodeParticleSystem(Game game) : base(game) { }
        ...
        public void LoadEvents()
        {
            ...
            ShockwaveColor = new Color(192, 0, 255);
            ShockwaveSize = 600;
            ShockwaveDuration = 0.25f;
