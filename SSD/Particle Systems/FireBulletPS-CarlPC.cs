...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    class FireBulletParticleSystem : DefaultTexturedQuadParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public FireBulletParticleSystem(Game cGame) : base(cGame) { }
        ...
        public void LoadParticleSystem()
        {
            ...
            TrailStartColor = Color.Orange;
            TrailEndColor = Color.Yellow;
            TrailStartSize = 150;
            TrailEndSize = 5;
            SetTexture("Textures/Particle");

            NumberOfParticlesToEmitScale = 0.01f;
        }
